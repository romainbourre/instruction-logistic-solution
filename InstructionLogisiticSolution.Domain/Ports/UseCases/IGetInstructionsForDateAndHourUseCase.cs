...
/// <summary>
/// This use case allow a user to get instructions for date and hour.
/// </summary>
/// <exception cref="ValidationException">If input is not correct, interface should be prevent by validation error.</exception>
public interface IGetInstructionsForDateAndHourUseCase : IUseCase<GetInstructionsForDateAndHourRequest, GetInstructionsForDateAndHourResponse>
{
}
